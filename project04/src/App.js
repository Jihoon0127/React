...
function App() {
  ...
  let students =[
    {name : '신지훈' ,age : 28, gender :'man'},
    {name : '신지훈1' ,age : 29, gender :'woman'},
    {name : '신지훈2' ,age : 30, gender :'man'}
  ]
    ...
    */
    ...
    let newStudents = students.map(item => item.name);
...
return (
  <div>
    ...
    {students.map(item => 
      <p key={item.name}>
        안녕하세요 저는 {item.name}입니다. 제 나이는 {item.age}살입니다.
      </p>
